...
{station:a,callback:b,socket:d,mediaDescription:{}});this.createPeer();this.registerSocketEvents()};
Receiver$$module$src$js$receiver_concat.prototype.registerSocketEvents=function(){var a=this,b=this.socket;b.on("your-id",function(c){a.client=c;console.debug("Got id",c);b.emit("logon",{from:a.client,to:a.station});b.removeAllListeners("your-id")});b.on("image-data",function(b){Object.assign(a.mediaDescription,b)});b.on("message",function(c){var d=a.peer;"candidate"===c.data.type?c.data.candidate&&d.addIceCandidate(new RTCIceCandidate(c.data.candidate)):"sdp"===c.data.type&&d.setRemoteDescription(new RTCSessionDescription(c.data.sdp),
...
Receiver$$module$src$js$receiver_concat.prototype.createPeer=function(){var a=this,b=this.getRtcConfigAndOptions(),c=this.socket;this.peer=new RTCPeerConnection(b.rtcConfig,b.rtcOptionals);this.peer.onicecandidate=function(b){c.emit("message",{from:a.client,to:a.station,data:{type:"candidate",candidate:b.candidate}})};this.peer.onaddstream=function(b){a.callback({streamUrl:b.stream})}};Receiver$$module$src$js$receiver_concat.prototype.getMediaDescription=function(){return this.mediaDescription};
var ReceiverChat$$module$src$js$receiver_concat=function(a,b){var c=io.connect();Object.assign(this,{id:b,station:a,socket:c})};ReceiverChat$$module$src$js$receiver_concat.prototype.sendMessage=function(a){this.socket.emit("chat",{station:this.station,from:this.id,message:a})};ReceiverChat$$module$src$js$receiver_concat.prototype.onMessage=function(a){this.socket.on("chat",function(b){a(b)})};
var receiver$$module$src$js$receiver_concat,duration$$module$src$js$receiver_concat,chat$$module$src$js$receiver_concat,currentTime$$module$src$js$receiver_concat;function getStation$$module$src$js$receiver_concat(){return(new URLSearchParams(document.location.search)).get("id")}
...
'url("'+a.cover+'")';$$$module$src$js$receiver_concat("#station-name").innerHTML="Station: "+getStation$$module$src$js$receiver_concat()}function registerChatHandler$$module$src$js$receiver_concat(){$$$module$src$js$receiver_concat("#send-message").addEventListener("click",function(){chat$$module$src$js$receiver_concat.sendMessage($$$module$src$js$receiver_concat("#message").value)})}
